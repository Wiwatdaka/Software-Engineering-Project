        ...
        <div class="grid_10">
            ...
            if(isset($_POST["submit1"]))
            {
                ...
                {   $v1=rand(1111,9999);
                    ...
                    mysqli_query($link,"update product set product_image='$dist1',product_name='$_POST[pnm]',product_price='$_POST[pprice]',product_qty='$_POST[pqty]',product_category='$_POST[pcategory]',product_desc='$_POST[pdesc]' where id=$id");
